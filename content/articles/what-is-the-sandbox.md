...
You earn the native token, $SAND by [“playing games, building games, and creating assets”](https://www.sandbox.game/en/create/game-maker/). Similar to Bitcoin, SAND is a supply capped token, which means that there is a max supply of 3 billion SAND. It is an [ERC-20 token](https://ethereum.org/en/developers/docs/standards/tokens/erc-20/) used to fuel the in-game economy, allow players to govern the Sandbox Game, and even stake it natively to earn interest.

Users can buy LAND within The Sandbox by spending their $SAND. LAND is a piece of digital real estate that acts like traditional real estate. Users can [buy, sell, and trade their LAND within The Sandbox marketplace](https://www.sandbox.game/en/shop/). At the time of writing the lowest price LAND available is priced at 2.25 ETH or $7.6k  Check out [this link](https://sandboxgame.gitbook.io/the-sandbox/land/what-can-you-do-with-land) to see the full extent of what owners can do with their land.

![](https://lh6.googleusercontent.com/YIn6_8-Vx4Hw_m9CvdTr0draocSbQ7K3PEjm4emEdREpPbfYlDgTy_uUcigwgdHFmtYsYOrayxuc5pUEYDKjzStCmBaZang4UH8OkYfyBkqqnFTaM2DaWu7QX7G88dv0wYSCNCsV)
...
The Sandbox was created in 2012 and began as a 2d sandbox game where users could build virtual worlds. This game was fairly successful and is still available on [the app store today](https://apps.apple.com/app/the-sandbox/id520777858), but it was never a blowout hit.  In 2017 Pixowl, the creators of Sandbox followed the crypto bull market and pivoted to becoming a blockchain-based company. In 2018 [Pixowl](https://www.pixowl.com/gamesposts/animoca-brands-acquires-pixowl-world-building-developer-of-the-sandbox/) was acquired by [Animoca Brands](https://www.animocabrands.com/), a software company out of Hong Kong that focuses on digital entertainment, blockchain, and gamification.
